...
struct FreeCursor { int8 req=95,pad; uint16 size=2; uint cursor; };
...
struct ChangeKeyboardControl { int8 req=102; uint16 size=4; uint mask=0xC0; uint key,autorepeat=0; };
