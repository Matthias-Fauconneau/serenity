...
struct GroupImageOperation : ImageGroupSource {
    ...
    size_t groupSize(size_t groupIndex) const override { return groups(groupIndex).size; }
...
struct BinaryImageGroupOperation : BinaryGenericImageOperation, ImageGroupSource {
    ...
    size_t groupSize(size_t groupIndex) const override { assert_(A.groupSize(groupIndex) == B.groupSize(groupIndex)); return A.groupSize(groupIndex); }
