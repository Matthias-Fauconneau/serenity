...
struct Result : shareable {
    ...
    long timestamp; /// Unix timestamp when this result finished succesfully computing [PersistentProcess: file last modified time]
    ...
    buffer<byte> data; /// Data (generated by Operation depending on inputs and arguments) [PersistentProcess: file content and memory mapped when possible]
};
