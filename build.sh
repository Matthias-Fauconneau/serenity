...
$CC -g -std=c++11 -DNO_PTHREAD -march=native -iquotecore core/thread.cc core/string.cc core/file.cc core/data.cc core/trace.cc core/time.cc build.cc -lstdc++ -lm -o $D/build &&
