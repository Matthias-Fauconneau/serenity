...
test $D/build -nt build.cc ||
$CC -g -std=c++1z -lpthread -march=native -Ofast -iquotecore core/string.cc core/thread.cc core/file.cc core/data.cc core/trace.cc build.cc -lstdc++ -lm -o $D/build &&
