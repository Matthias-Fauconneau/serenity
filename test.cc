...
struct IDE {
	...
	void parse(Scope& module, string fileName) {
		if(!edits.contains(fileName)) {
			FileTextEdit* edit = new FileTextEdit(fileName, module, {this, &IDE::parse});
			...
			edit->edit.textChanged = [this, edit](string) {
				...
				edit->edit.text = move(Parser(toUTF8(strip(edit->edit.text)), edit->fileName, this->module, {this, &IDE::parse}).target);
