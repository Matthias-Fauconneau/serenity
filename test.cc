...
struct Calculator {
    Calculator() {
        ...
        parser["integer"_]=  [](ref<byte> token){ return toInteger(token); };
        parser["add"_] =  [](float a, float b){ return a+b; };
        parser["sub"_] = [](float a, float b){ return a-b; };
        parser["mul"_] = [](float a, float b){ return a*b; };
        parser["div"_] =  [](float a, float b){ return a/b; };
