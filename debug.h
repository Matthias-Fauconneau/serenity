...
#define check(expr, message...) ({ long e=(long)expr; debug( if(e<0 && -e<58) error(#expr##_, errno[-e], ##message); ) e; })
#define check_(expr, message...) ({ long unused e=expr; debug( if(e<0 && -e<58) error(#expr##_, errno[-e], ##message); ); })
