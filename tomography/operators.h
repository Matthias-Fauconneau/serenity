...
CL(operators, divmul) inline uint64 divmul(const ImageArray& y, const ImageArray& a, const ImageArray& b, const ImageArray& c) { return emulateWriteTo3DImage(CL::divdiff, y, noneNearestSampler, a, b, c); } // y = a / (b * c) [MLEM]
