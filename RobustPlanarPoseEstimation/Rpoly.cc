...
static void QuadSD(int NN, double u, double v, double p[maxDegree+1], double q[maxDegree+1], double* a, double* b)
{
...
static int calcSC(int N, double a, double b, double* a1, double* a3, double* a7, double* c, double* d, double* e, double* f, double* g, double* h, double K[maxDegree+1], double u, double v, double qk[maxDegree+1])
{
...
static void nextK(int N, int tFlag, double a, double b, double a1, double* a3, double* a7, double K[maxDegree+1], double qk[maxDegree+1], double qp[maxDegree+1])
{
...
static void newest(int tFlag, double* uu, double* vv, double a, double a1, double a3, double a7, double b, double c, double d, double f, double g, double h, double u, double v, double K[maxDegree+1], int N, double p[maxDegree+1])
{
...
static void QuadIT(int N, int* NZ, double uu, double vv, double* szr, double* szi, double* lzr, double* lzi, double qp[maxDegree+1], int NN, double* a, double* b, double p[maxDegree+1], double qk[maxDegree+1], double* a1, double* a3, double* a7, double* c, double* d, double* e, double* f, double* g, double* h, double K[maxDegree+1])
{
...
static void RealIT(int* iFlag, int* NZ, double* sss, int N, double p[maxDegree+1], int NN, double qp[maxDegree+1], double* szr, double* szi, double K[maxDegree+1], double qk[maxDegree+1])
{
...
static void Fxshfr(int L2, int* NZ, double sr, double v, double K[maxDegree+1], int N, double p[maxDegree+1], int NN, double qp[maxDegree+1], double u, double* lzi, double* lzr, double* szi, double* szr)
{
    ...
    double qk[maxDegree+1], svk[maxDegree+1];
...
void rpoly(double op[maxDegree+1], int* Degree, double zeror[maxDegree], double zeroi[maxDegree]) {
    int i, j, jj, l, N, NM1, NN, NZ, zerok;

    double K[maxDegree+1], p[maxDegree+1], pt[maxDegree+1], qp[maxDegree+1], temp[maxDegree+1];
