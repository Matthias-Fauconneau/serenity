...
String str(double number, uint precision=3, uint exponent=0, uint pad=0);
inline String str(float n, uint precision=3, uint exponent=0) { return str(double(n), precision, exponent); }
