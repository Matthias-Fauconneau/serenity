...
template<> inline v8si min(v8si a, v8si b) { return __builtin_ia32_pminsd256(a, b); }
template<> inline v8si max(v8si a, v8si b) { return __builtin_ia32_pmaxsd256(a, b); }
...
template<> inline v8sf rcp(v8sf x) { return __builtin_ia32_rcpps256(x); }
