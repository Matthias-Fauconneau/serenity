...
$ROCK downsample minimalSqRadius=25 floodfill=0 distribution-radius-scaled histogram-radius porosity volume volume-total cdl test || die
$ROCK downsample minimalSqRadius=25 floodfill=1 distribution-radius-scaled histogram-radius porosity volume volume-total cdl test || die
