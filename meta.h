...
template<typename T> struct is_pointer
        : public integral_constant<bool, (is_pointer_helper<typename remove_const<T>::type>::value)> {};

template<typename T> struct is_member_pointer_helper : public false_type { };
template<typename T, typename C> struct is_member_pointer_helper<T C::*> : public true_type { };
...
template<typename From, typename To> class is_convertible_helper<From, To, false> : public sfinae_types {
